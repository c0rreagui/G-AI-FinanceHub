...
export const HomeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z", "M9 22V12h6v10"]} {...props} />;
...
export const TrendingDown: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["m 22 17 -8.29 -8.29 a2 2 0 0 0 -2.83 0L8 11.59l-4.29-4.3a2 2 0 0 0 -2.83 0L1 7", "M22 7v10h-10"]} {...props} />;
export const TrendingUp: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["m 22 7 -8.29 8.29 a2 2 0 0 1 -2.83 0L8 12.41l-4.29 4.3a2 2 0 0 1 -2.83 0L1 17", "M22 17V7h-10"]} {...props} />;
...
export const Wrench: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <Icon d="M 14.7 6.3 a 1 1 0 0 0 0 1.4 l 1.6 1.6 a 1 1 0 0 0 1.4 0 l 3.77 -3.77 a 6 6 0 0 1 -7.94 7.94 l -6.91 6.91 a 2.12 2.12 0 0 1 -3 -3 l 6.91 -6.91 a 6 6 0 0 1 7.94 -7.94 l -3.76 3.76 z" {...props} />;
...
export const PencilIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z", "m 15 5 4 4"]} {...props} />;
...
export const UploadCloud: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242", "m 12 12 -4 -4 -4 4", "M12 12v9"]} {...props} />;
...
export const PiggyBank: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["m 10 13.1 -1.5 -1.5", "M 14 10.9 12.5 9.4", "m 13 14 -4 -4", "m 5 8 2 2", "M9 17h1", "M15 17h1", "M22 17v-1c0-1.7-1.3-3-3-3h-1", "M3 14c-1.1 0-2 .9-2 2v1h2", "M17 16c-1.7 0-3 1.3-3 3v1h4v-1c0-1.7-1.3-3-3-3Z"]} {...props} />;
...
export const Car: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["M14 16H9 m 10 0h1","M4 16H3","m 14 -6 -1 -5H7L6 10","m 15 6 -1.5 -2","M6 10l-1.5-2","M12 20a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1Z"]} {...props} />;
export const Shirt: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["m 21 4 -1.83 -2.74 a 2 2 0 0 0 -3.34 0L14 4", "m 1 14 3 -3 4 4 5 -5 5 5", "M2 20h20"]} {...props} />;
...
export const Dumbbell: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["m 12 6 -2 -2 -2 2", "m 6 12 2 -2 2 2", "m 18 12 2 -2 -2 -2", "m 12 18 2 2 2 -2", "M17 7 7 17"]} {...props} />;
export const Gamepad: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["M14 6L12 8l-2-2","M6 14l-2 2 2 2","m 14 0 2 2 -2 2","M10 18v-4h4v4Z","M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Z"]} {...props} />;
...
export const LinkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <CompoundIcon paths={["M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.72", "M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.72-1.72"]} {...props} />;