...
export const Calendar: React.FC<IconProps> = (props) => (
  <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M-4.5 12h18" /></Icon>
);
...
export const Shirt: React.FC<IconProps> = (props) => (
  <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 01-1.161.886l-.143.048a1.109 1.109 0 00-.57 1.664c.369.555.169 1.307-.427 1.605L9 13.125l.423 1.059a.956.956 0 01-1.632.524l-.052-.082a2.25 2.25 0 00-3.292 0l-.052.082a.956.956 0 01-1.632-.524l.423-1.059L3 13.125c-.6-.298-.797-1.05-.427-1.605a1.109 1.109 0 00-.57-1.664l-.143-.048a2.25 2.25 0 01-1.161-.886l-.51-.766c-.32-4.8.04-1.121.216-1.49l1.068-.89a1.125 1.125 0 00.405-.864v-.568a1.125 1.125 0 011.125-1.125h3.375a1.125 1.125 0 011.125 1.125z" /></Icon>
);
